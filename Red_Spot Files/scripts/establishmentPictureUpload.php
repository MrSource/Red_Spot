...
$upload_folder ='../uploads/establishmentPics/';
...
if($tamano_archivo > 5242880){
    ...
    $files = scandir("../uploads/establishmentPics/");
    $fileExists = FALSE;
    ...
    if($fileExists){
        ...
        //Proceed to try to upload
         if (!move_uploaded_file($tmp_archivo, "../uploads/establishmentPics" . "/" . $nombre_archivo)) {
